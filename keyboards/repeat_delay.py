...
def repeat_delay_keyboard():
    ...
    kb.button(
        ...
        style="primary",
        icon_custom_emoji_id="5915991999093149658"
    )
    ...
    kb.button(
        ...
        style="primary",
        icon_custom_emoji_id="6024035324512964552"
    )
    ...
    kb.button(
        ...
        style="primary",
        icon_custom_emoji_id="5915735340437474837"
    )
    ...
    kb.button(
        ...
        style="primary",
        icon_custom_emoji_id="5913241115489734452"
    )
    ...
    kb.button(
        ...
        style="primary",
        icon_custom_emoji_id="5805523262691611326"
    )
